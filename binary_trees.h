...
bst_t *re_node(binary_tree_t **t, binary_tree_t *node);
...
size_t re_height(const binary_tree_t *tree, size_t count);
...
int re_complete(const binary_tree_t *tree, int i, int height);
